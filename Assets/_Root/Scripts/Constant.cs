...
namespace Pancake.SceneFlow
{
    public static class Constant
    {
        ...
        public const string IDLE_2_RUN = "Idle2Run";
        public const string IDLE_2_BIKE = "Idle2Bike";
        public const string IDLE = "Idle";
        public const string SEED_FARM = "SeedFarm";
        ...
        public const string PREDATOR_ATTACK = "Attack";
        public const string PREDATOR_DIE = "Die";
        public const string PREDATOR_HITTED = "Being_Hitted";
